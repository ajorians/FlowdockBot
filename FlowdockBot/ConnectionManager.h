...
{
public:
   virtual void MessageSaid(const std::string& strOrg, const std::string& strFlow, int nType, int nUserID, const std::string& strMessage, int nMessageID)  = 0;
};
...
public:
   ...
   //IManager
   void MessageSaid(const std::string& strOrg, const std::string& strFlow, int nType, int nUserID, const std::string& strMessage, int nMessageID);
...
protected:
   ...
   void NotifyHandlers(const std::string& strOrg, const std::string& strFlow, int nType, int nUserID, const std::string& strMessage, int nMessageID);
